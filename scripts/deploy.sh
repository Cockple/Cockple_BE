...
ASYNC_NOTIFICATION_CORE_SIZE=${ASYNC_NOTIFICATION_CORE_SIZE:-4}
ASYNC_NOTIFICATION_MAX_SIZE=${ASYNC_NOTIFICATION_MAX_SIZE:-12}
ASYNC_NOTIFICATION_QUEUE_CAPACITY=${ASYNC_NOTIFICATION_QUEUE_CAPACITY:-1000}
EOF
