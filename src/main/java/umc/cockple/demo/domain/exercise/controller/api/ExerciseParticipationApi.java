...
@ExerciseApiTag
public interface ExerciseParticipationApi {
    ...
    ResponseEntity<BaseResponse<ExerciseJoinDTO.Response>> joinExercise(
    ...
    ResponseEntity<BaseResponse<ExerciseCancelDTO.Response>> cancelParticipation(
            @PathVariable Long exerciseId
    );
    ...
    @ApiResponse(responseCode = "404", description = "운동 또는 참여 기록을 찾을 수 없음")
    ResponseEntity<BaseResponse<ExerciseCancelDTO.Response>> cancelParticipationByManager(
            @PathVariable Long exerciseId,
