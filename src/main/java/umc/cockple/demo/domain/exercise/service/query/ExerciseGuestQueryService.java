...
public class ExerciseGuestQueryService {
    ...
    public ExerciseMyGuestListDTO.Response getMyInvitedGuests(Long exerciseId, Long memberId) {
        ...
        if (myGuests.isEmpty()) {
            ...
            return exerciseGuestMapper.toEmptyGuestListResponse();
        }
        ...
        return exerciseGuestMapper.toMyGuestListResponse(statistics, guestInfoList);
    }
    ...
    private List<ExerciseMyGuestListDTO.GuestInfo> buildGuestInfoList(
        ...
        return myGuests.stream()
                .map(guest -> exerciseGuestMapper.toGuestInfo(guest, guestNumberMap, inviterName))
                .toList();
    }
