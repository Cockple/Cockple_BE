...
public enum ExerciseErrorCode implements BaseErrorCode {
    ...
    EXERCISE_PARTICIPATION_NOT_FOUND(HttpStatus.NOT_FOUND, "EXERCISE204", "존재하지 않는 운동 참여입니다."),
    ...
    GAME_HOST_MANAGEMENT_PERMISSION_DENIED(HttpStatus.FORBIDDEN, "EXERCISE306", "게임 진행자를 관리할 권한이 없습니다."),
    ...
    INVALID_GAME_HOST_CANDIDATE(HttpStatus.BAD_REQUEST, "EXERCISE412", "게임 진행자는 활성 모임원만 지정할 수 있습니다.");
