...
public enum PartyErrorCode implements BaseErrorCode {
    ...
    MALE_LEVEL_REQUIRED(HttpStatus.BAD_REQUEST, "PARTY104", "혼복 모임은 남녀 급수 설정이 필수입니다."),
    INVALID_REQUEST_STATUS(HttpStatus.BAD_REQUEST, "PARTY105", "유효하지 않은 가입 신청 상태입니다. (PENDING 또는 APPROVED를 입력해주세요.)"),
